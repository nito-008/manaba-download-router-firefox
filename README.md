...
[A] Firefox拡張機能ストアから追加: 

https://addons.mozilla.org/ja/firefox/addon/manaba-download-router/

[B] GitHubのReleasesからzipファイルをダウンロードして追加:
1. [最新のRelease](https://github.com/nito-008/manaba-download-router-firefox/releases/latest) から `manaba-download-router-[version]-firefox.zip`をダウンロード
2. about:debugging#/runtime/this-firefox にアクセス
3. 一時的なアドオンを追加...からzipファイルを読み込む（ブラウザを閉じると削除されます）
